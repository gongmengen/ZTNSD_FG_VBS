            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="<%=basePath%>websiteList_lar">网站列表(地方)</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<script type="text/javascript">
    ...
    function intoPipeline(id) {
        window.location.href="<%=basePath%>getInformation_lar/"+id;
    }
    //查看适配结果
    function checkResult(id) {

        window.location.href="<%=basePath%>regsinglenews/"+id;
    }
</script>
</body>
