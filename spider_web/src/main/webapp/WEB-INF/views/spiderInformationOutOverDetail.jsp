            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="/informationPipeline">新闻列表</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    ...
                    <c:if test="${lastid > -1}">
                        <a href="<%=path%>/outOverInformationDetail/${lastid}/${sessionScope.xwcolumn}" class="btn btn-primary">上一篇</a>
                    </c:if>
                    <c:if test="${lastid == -1}">
                        <a href="javascript:void(0);" class="btn btn-default">上一篇</a>
                    </c:if>
                    <c:if test="${nextid > -1}">
                        <a href="<%=path%>/outOverInformationDetail/${nextid}/${sessionScope.xwcolumn}" class="btn btn-primary">下一篇</a>
                    </c:if>
                    <c:if test="${nextid == -1}">
                        <a href="javascript:void(0);" class="btn btn-default">下一篇</a>
                    </c:if>
                </div>
            </div>
        </div>
...
--%>
    <p><a href="http://47.93.149.25:8082/nextPage/1/${informationPipeline.informationId}" style="font-size: 25px;">⚙</a>     标题：${informationPipeline.newstitle}</p>
    <p><a href="http://47.93.149.25:8082/nextPage/4/${informationPipeline.informationId}" style="font-size: 25px;">⚙</a>     文号：${informationPipeline.filenum}</p>
    <p><a href="http://47.93.149.25:8082/nextPage/3/${informationPipeline.informationId}" style="font-size: 25px;">⚙</a>     发布日期：${informationPipeline.releasetime}</p>
    <p><a href="http://47.93.149.25:8082/nextPage/6/${informationPipeline.informationId}" style="font-size: 25px;">⚙</a>     附件：${informationPipeline.attachment}</p>
    <p><a href="http://47.93.149.25:8082/nextPage/2/${informationPipeline.informationId}" style="font-size: 25px;">⚙</a>     正文：</p>
                    </div>
