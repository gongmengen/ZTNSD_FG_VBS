...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>已适配网站列表</h2>
                <h4 style="color: red">ps：通过  ‘查找’  功能搜索将要同步的网站模板，并点击  ‘传递脚本’  按钮，即可完成脚本同步</h4>
                <ol class="breadcrumb">
                    <li>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <c:forEach items="${websiteList}" var="websiteList">
                                    <tr class="gradeX">
                                        ...
                                        <%--<td class="center"><a href=>传递脚本</a> </td>--%>
                                        <td class="center"><button type="button" class="btn btn-primary btn-sm" onclick="reg(${websiteList.id})">传递脚本</button></td>
                                    </tr>
...
<script type="text/javascript">
    ...
    function reg(id) {
        ...
        var targetUrl = "<%=basePath%>copyCode/"+id+"/${siteids}";
