        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="search_results.html#"><i class="fa fa-bars"></i> </a>
                        ...
                        <div class="ibox-content">
                            ...
                            <c:forEach items="${informationList}" var="information">
                                ...
                                <div class="search-result">
                                    <h3><a href="<%=basePath%>regsinglenewsWithReset/${information.id}/${xwcolumn}">${information.newstitle}</a></h3>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
