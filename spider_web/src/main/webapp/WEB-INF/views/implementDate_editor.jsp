            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="<%=basePath%>websiteList">适配网站</a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <form id="myform" action="<%=basePath%>regsinglecode" method="post">
                        ...
                        <input type="hidden" id="codetype" name="codetype" value="5">
    ...
    function reg() {
        ...
        if (!isQuery) {
            $.ajax({
                ...
                url: targetUrl,
                cache: false,
                data: {"implementdate": title, "informationid": informationid, "codetype": codetype},
