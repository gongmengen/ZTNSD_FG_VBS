...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <button type="button" class="btn btn-primary btn-sm" onclick="lastPage(3)">上一步</button>
            <button type="button" class="btn btn-primary btn-sm" onclick="nextPage(6)">下一步</button>
            <div class="col-lg-10">
                <h2>文号脚本</h2>
                <ol class="breadcrumb">
                    <li>
            ...
            <div class="col-lg-2">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<%=basePath%>nextPage/1/${information.id}">标题</a>
                        </li>
                        <li><a href="<%=basePath%>nextPage/2/${information.id}">正文</a>
                        </li>
                        <li><a href="<%=basePath%>nextPage/3/${information.id}">发布日期</a>
                        </li>
                        <li><a href="<%=basePath%>nextPage/4/${information.id}">文号</a>
                        </li>
                        <li><a href="<%=basePath%>nextPage/6/${information.id}">附件</a>
                        </li>
                        <li><a href="<%=basePath%>regsinglenews/${information.id}">新闻适配结果预览</a>
                        </li>
                        <li><a href="<%=basePath%>regten/${information.websiteid}/${information.id}">网站适配结果预览</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <form id="myform" action="<%=basePath%>regsinglecode" method="post">
                        ...
                        <input type="hidden" id="codetype" name="codetype" value="4">
                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <div class="textarea">
                                    <c:choose>
                                        <c:when test="${adapter.newnum == null||adapter.newnum.equals('')}">
...
function wenhao_special(str) {
    first_token ="<div class=\"content\">";
    first_idx = str.indexOf(first_token);
    if(first_idx==-1) return "";
    start_token = "<span ";
    start_token_atrrib="666666";
    end_token = "</span>";
    ...
    function reg() {
        ...
        if (!isQuery) {
            $.ajax({
                ...
                url: targetUrl,
                cache: false,
                data: {"newnum": title, "informationid": informationid, "codetype": codetype},
