            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="/informationPipelinelar">地方法规</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="<%=basePath%>informationPipelinelar#"><i class="fa fa-bars"></i> </a>
...
<%--                <div class="btn-group">
                    <button data-toggle="dropdown" class="btn btn-warning dropdown-toggle">定时器<span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="javascript:void(0);" onclick="closeTimer()">关闭定时器</a></li>
                                                     ...
                                                     <c:if test="${sessionScope.user.level < 0}">
                                                         <button type="button" class="btn btn-primary btn-sm" onclick="output('ddd')">最新导出</button>
                                                     </c:if>
                <button type="button" class="btn btn-primary btn-sm" onclick="output('ccc')">导出</button>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a class="dropdown-toggle" data-toggle="dropdown" href="<%=basePath%>informationPipelinelar#">
...
<script>
   ...
   function outPutOver() {
       window.location.href="<%=basePath%>/outPutOver/100003";
   }
   //导出
   ...
   function openDetail(data) {
       window.open("<%=path%>/informationDetail/"+data+"/100003",'_blank');
   }
