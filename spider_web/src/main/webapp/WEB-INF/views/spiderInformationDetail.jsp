        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    ...
                    <c:if test="${lastid > -1}">
                        <a href="<%=path%>/informationDetail/${lastid}/${sessionScope.xwcolumn}" class="btn btn-primary">上一篇</a>
                    </c:if>
                    <c:if test="${lastid == -1}">
                        <a href="javascript:void(0);" class="btn btn-default">上一篇</a>
                    </c:if>
                    <c:if test="${nextid > -1}">
                        <a href="<%=path%>/informationDetail/${nextid}/${sessionScope.xwcolumn}" class="btn btn-primary">下一篇</a>
                    </c:if>
                    <c:if test="${nextid == -1}">
