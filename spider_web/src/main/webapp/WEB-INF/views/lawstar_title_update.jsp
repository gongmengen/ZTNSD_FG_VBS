...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="col-lg-2">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<%=basePath%>nextPage/6/${informationPipeline.informationId}">新闻适配结果预览</a>
                        </li>
                        <li><a href="<%=basePath%>nextPage/6/${informationPipeline.informationId}">网站适配结果预览</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
            <div class="row">
                <div class="col-lg-66">
                    <form id="myform" action="<%=basePath%>lawstar_title_update_upd" method="POST">
