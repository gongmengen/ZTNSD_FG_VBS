...
public class InformationPipeline {
    private Integer id;
    ...
    public void setNewstitle(String newstitle) {
        this.newstitle = newstitle == null ? null : newstitle;
    }
    ...
    public String getXwcolumn() {
        return xwcolumn;
    }

    public void setXwcolumn(String xwcolumn) {
        this.xwcolumn = xwcolumn == null ? null : xwcolumn.trim();
    }
    ...
    public void setWebsitesource(String websitesource) {
        this.websitesource = websitesource == null ? null : websitesource.trim();
    }
    ...
    public void setFjcount(Integer fjcount) {
